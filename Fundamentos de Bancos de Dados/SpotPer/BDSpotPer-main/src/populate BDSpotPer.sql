...
insert into faixa values (2, 3, 'Di due rai languir costante', 'DDD', 3450,2);
...
insert into compositor_faixa values (2, 2, 5);
insert into compositor_faixa values (4, 2, 6);
...
insert into compositor_faixa values (8, 4, 8);
...
insert into playlist values ('Cooking Songs', '2021-01-08', NULL);

-- playlist_faixa (codigo_playlist, codigo_album, numero_faixa, numero_reproducoes,data_ultima_reproducao)

insert into playlist_faixa values (1, 1, 1, 25, '2021-02-03');
